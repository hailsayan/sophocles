...
func NewProductDeletedProducer(producer sarama.AsyncProducer) mq.KafkaProducer {
...
func (p *ProductDeletedProducer) Send(ctx context.Context, event mq.KafkaEvent) error {
...
func (p *ProductDeletedProducer) HandleErrors() {
...
func (p *ProductDeletedProducer) Retry() {
...
func (p *ProductDeletedProducer) UnmarshalMetadata(msg *sarama.ProducerMessage, metadata *mq.KafkaMetadata) {
	if msg.Metadata == nil {
		return
	}
